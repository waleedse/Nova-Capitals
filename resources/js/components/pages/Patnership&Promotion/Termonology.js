        ...
        return (
            <div>
                <div className="ter_bg">
                    <div>
                        <div className='title_' ><span className='titleLg'>Nova Capitals<br />
                ...
                <h1 className="title_ text-center py-4" style={{color:'#fff'}} >
                Nova Capitals Investment Terminalogy</h1>
                </div>
                <div className="bt4S_bottom">
                    <div className="container">
                    <div className="sec4 ">
                            <h1 className="title_ text-center" style={{color:'#fff'}}> <span style={{fontSize:'22px'}}>
                        ...
                        <div className="sec4 ">
                            ...
                            500 times less than the contract size. For example, the current EUR/USD bid is 1.13501 and you would like to open 0.5 lots Sell order. If your leverage is 1:500 the margin required for such order can be calculated like this: 50 fff EUR
                        ...
                        <div className="sec4 ">
                            ...
                            1 pip is still calculated by the 4th digit (0.fff1). The smallest unit is now referred as to point (0.fff01).
