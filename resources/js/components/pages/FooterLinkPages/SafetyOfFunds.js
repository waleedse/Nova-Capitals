...
const SafetyOfFunds = () => {
    return (
        <div>
            ...
            <HeroSection title="CLIENT'S SAFETY OF FUNDS" text="Al Awal Markets - True ECN Forex Broker" />
            <div className=' footerLinkPage'>
                <div className="basicRow">
                Al Awal Markets has thousands of clients from all around the world, thanks to our regulations and emphasis on safety and security of funds.
<br/><br/>
Regardless of the situation, our number one aim is to protect our clients’ investment. Our clients trust our services as we create a reliable and safe environment.
                  ...
                  <div className="basicText">At Al Awal Markets, we gained the trust of our clients as we store their funds in accounts from reputed banks. If you want more information regarding our partnership with banks, take a look at the accounts section.</div>
                    </div>
                    </div>
            {/* <TradingComponent /> */}
            {/* <StepsToOpenAccount /> */}
