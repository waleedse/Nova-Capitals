...
const Bonus_335per_tc = () => {
    return (
        <div>
            <HeroSection title="$50 NO DEPOSIT WELCOME BONUS" text="Nova Capitals brings a whopping $50 No Deposit Welcome Bonus to your trading account deposit.
...
" />
            <div className=' footerLinkPage'>
                <div className="basicRow">
                 ...
                 <br></br>
                 1.	Subject to, and without prejudice to, all other Business Terms and Policies, the offer is available to Nova Capitals Clients who have satisfied the Eligibility Criteria for the offer (“Eligible Clients”) as set out in the sections following hereinafter.
                 ...
                 <br></br> <br></br>8.	$50 No Deposit Bonus will be automatically credited to your No Deposit Account within 24 hours of verification of profile. In case it is not credited in the specified time, please email us on support@novacapitals.com
                 ...
                 <br></br> <br></br>10.	Nova Capitals reserves the right to reject a bonus request or block the No Deposit Bonus Account, if there is a partial or complete match of IP address or other signs of No Deposit Bonus Account belonging to the same person, or in case of any suspicious activity.
                 ...
                 <br></br> <br></br>c.	After a deposit is made to Live Standard Account Client should contact Nova Capitals back office via email Support@novacapitals.com and request to transfer the profit from the no deposit bonus account to the Live Standard Account (Mt4/M5).
                 ...
                 <br></br> <br></br>19.	Nova Capitals reserves the right to disqualify any user, if there is a suspicion of misuse or abuse of fair rules.

                 <br></br> <br></br>20.	Participation of “Intermediaries/Related Parties” in the “No Deposit Trading Bonus Scheme” is prohibited. If the registration and / or trading data of a participant in the “No Deposit Trading Bonus Scheme” corresponds with the registration and / or trading information, including but not limited to IP address, of another participant in the “No Deposit Trading Bonus Scheme”, Nova Capitals reserves the right to regard this matching as a reason for immediate disqualification. For the purposes hereof, the term “Intermediary(ies)/Related Party(ies)”, when used in these Terms & Conditions, unless the context otherwise requires, shall mean to include any person or entity bearing a relationship with any participant in the “No Deposit Trading Bonus Scheme”, including, without limitation:
                 ...
                 <br></br> <br></br>22.	Under no circumstances shall Nova Capitals be liable for any consequences of any trading bonus cancelation or decline, including, but not limited to, order(s) closure by Stop Out.

                 <br></br> <br></br>23.	Nova Capitals reserves the right to alter, amend or terminate the “No Deposit Trading Bonus Scheme” or any aspect of it at any time. Prior notice of such changes will be given to clients and Nova Capitals will post any such changes on its website. It is recommended that participants in the “No Deposit Trading Bonus Scheme” consult these Terms & Conditions on Nova Capitals website regularly. Please note that taking part in the “No Deposit Trading Bonus Scheme” constitutes acceptance and agreement to abide by any such alterations, amendments and/or changes.

                 <br></br> <br></br>24.	Any indication or suspicion, in the Company’s reasonable discretion, of any form of arbitrage (including but not limited to risk free profiting), abuse (including but not limited to participant's trading activity patterns that indicate that the participant solely aims to benefit financially from the trading bonus without being genuinely interested in trading in the markets and/or taking market risk), Bonus Hedging, fraud, manipulation, cash-back arbitrage connected to a trading bonus or any other forms of deceitful or fraudulent activity, will nullify all previously credited trading bonus of the Eligible Client’s real trading Accounts with Nova Capitals and/or any and all transactions carried and/or profits or losses garnered therein. Hedging trading positions internally (using other trading accounts held with Nova Capitals) or externally (using other trading accounts held with other brokers) to avoid market risk is not allowed. In these circumstances, Nova Capitals reserves the right, at its reasonable discretion to close/suspend (either temporarily or permanently) all such Eligible Client’s real trading Account(s) with Nova Capitals, cancel all orders and annul all profits of such participant. In these circumstances, Nova Capitals shall not be liable for any consequences of the trading bonus cancelation, including, but not limited to, order(s) closure by Stop Out.

                 <br></br> <br></br>25.	In the event that Account becomes dormant all previously awarded trading bonuses will be immediately withdrawn from the respective Eligible Clients real account with Nova Capitals.
                 ...
                 <br></br> <br></br>27.	Nova Capitals, at its reasonable discretion, offers the “No Deposit Trading Bonus Scheme” to any Client(s) and/or any countries / regions as it deems appropriate and for as long as Nova Capitals deems to provide it.
                 ...
                 <br></br> <br></br>30.	Taking part in the “No Deposit Trading Bonus Scheme” constitutes acceptance of these Terms & Conditions and of the Business Terms and Policies set forth on Nova Capitals Market’s website.
