                ...
                <div className="container mt-5 mb-5">
                    <div className="card stats_card p-4">
                        <div className="row ">
                            ...
                            <button onClick={()=>{ window.open('https://secure.alawalmarkets.com/#/auth/login/','_self')}} className="depositButton rounded" style={{padding:"8px 60px",fontSize:'24px'}} >Invest</button>
                    ...
                    <div className="text-center px-2 mt-5 ">
                        <div className="row ml-auto mr-auto">
                            ...
                            <button onClick={()=>{ window.open('https://secure.alawalmarkets.com/#/auth/login/','_self')}} className="depositButton ml-2 mt-2 rounded" style={{padding:"8px 60px",fontSize:'24px'}} >Invest</button>
